...
```mermaid
flowchart LR
    M1["📦 Module 1<br>Meet Claude Cowork<br>(L1-L4)"] --> M2["🛠️ Module 2<br>Make Claude Cowork Yours<br>(L5-L8)"]
    M2 --> M3["🌐 Module 3<br>Use Claude wherever you work<br>(L9-L10)"]
    M3 --> M4["🛡️ Module 4<br>Sharing and safety<br>(L11-L13)"]
...
| 模块 | 主题 | 你获得了什么 |
| :--- | :--- | :--- |
| **Module 1**<br>Meet Claude Cowork | Cowork 是什么、与 Chat/Code 的区别、它为哪类工作而生、你的第一个真实任务 | 认识委派范式：描述目标 → Claude 规划执行 → 你全程掌舵 |
| **Module 2**<br>Make Claude Cowork Yours | Global Instructions、Projects、Skills、Plugins | 当 Cowork **知道你所知道的、能访问你所能访问的、按你团队的方式做事**时，能力会发生质的跃升 |
| **Module 3**<br>Use Claude wherever you work | Claude in Chrome、Claude for M365（Word/Excel/PPT/Outlook） | Cowork 延伸到桌面之外：浏览器里的无 Connector 系统 + Office 文档内部 |
| **Module 4**<br>Sharing and safety | 负责任地使用自主权（安全实践）、验证你构建的东西（Evals）、把个人工作流变成团队基础设施（分发治理） | 把 Cowork 交给真实工作后，让它**安全、可靠、可规模化** |
...
```mermaid
flowchart LR
    A["💬 Chat<br>思考与对话"] -.->|"范式跃迁<br>beyond chat"| B["👥 Cowork<br>委派真实工作<br>Hand off a task,<br>get a polished deliverable"]
    B --> C["交接一个任务，<br>取回一份打磨好的成品"]
```
...
```mermaid
flowchart LR
    A["✅ L1-L4 认识 Cowork<br>委派范式·环境搭建·任务模式·Task Loop"] --> B["✅ L5-L8 个性化<br>四大构建块·上下文·Skills·Plugins"]
    B --> C["✅ L9-L10 全界面<br>Chrome·M365"]
    C --> D["✅ L11-L13 安全与共享<br>安全实践·Evals·团队分发"]
    D --> E["🏁 剩余：结课测验<br>Quiz on Claude Cowork<br>（约 8 分钟，登录后作答）"]
