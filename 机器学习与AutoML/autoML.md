# 自动化机器学习（AutoML）核心技术与理论综述

> 本文系统性梳理 AutoML 的核心研究方向与技术体系，涵盖超参数优化（HPO）、元学习（Meta-Learning）、神经网络架构搜索（NAS）、全流程 Pipeline 自动化以及主流 AutoML 开源系统的架构选型与对比。
...
- [1. 背景与核心问题](#1-背景)
- [2. 超参数优化 (HPO)](#2-超参数优化hpo)
  - [2.1 定义与参数空间](#21-定义)
  - [2.2 Model-Free 优化 (网格 / 随机搜索)](#22-model-free-optimization)
  - [2.3 Population-Based 群体优化 (遗传 / CMA-ES)](#23-population-base)
  - [2.4 贝叶斯优化 (GP, Surrogate Model, Acquisition Function)](#24-贝叶斯优化)
  - [2.5 多保真度优化 (Multi-Fidelity, Hyperband, BOHB)](#27-multi-fidelity-optimization)
  - [2.6 选型准则与开放问题](#210-实际应用)
- [3. 元学习 (Meta-Learning)](#3-meta-learning)
  - [3.1 从模型评估中学习 (配置空间设计与迁移)](#31-从模型评估中学习)
  - [3.2 从任务属性中学习 (Task Meta-Features 与时序元特征)](#32-从任务属性中学习)
  - [3.3 从历史模型中学习 (Few-Shot, MAML)](#33-从之前的模型中学习)
- [4. 神经网络架构搜索 (NAS)](#4-nas)
- [5. 全流程 Pipeline 自动化 (数据准备与特征工程)](#5-全pipeline自动化)
- [6. 主流 AutoML 系统选型与架构分析 (Auto-sklearn, TPOT, AutoGluon, Optuna)](#6-automl-systems)
...
* 信息论中的各种指标，例如 class entropy，mutual information，noise-signal ratio 等
...
* Significance of the first, second and third autocorrelation (TAC1, TAC2 and TAC3): indicates significant dependences in more recent past points.
* Coefficient of variation (COEF-VAR): measures the degree of instability in the series.
* Absolute value of the skewness and kurtosis coefficient (KURT and SKEW): measure the degree of non-normality in the series.
* Test of Turning Points for randomness (TURN): A point $Z_t$ is a turning point of a series if $Z_{t-1} < Z_t > Z_{t+1}$, or $Z_{t-1} > Z_t < Z_{t+1}$. The presence of a very large or a very low number of turning points in a series suggests that the series is not generated by a purely random process.
